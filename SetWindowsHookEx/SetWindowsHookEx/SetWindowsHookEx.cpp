// SetWindowsHookEx.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
// a key is pressed.
// The parameters here can are automatically passed depending on the hook tipe, for example:
