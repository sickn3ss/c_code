...
int main() {
	...
	ULONGLONG allocate_address = 0x44000000;
	LPVOID allocate_buffer;
	allocate_buffer = VirtualAlloc((LPVOID*)allocate_address, 0x700, MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE);
